...
const Schedule = () => {
    return (<div className="flex flex-col justify-start items-start w-full bg-[#191921] sm:flex-row sm:h-[538px] lg:h-[705px]">
        <div className="flex w-full h-[200px] sm:w-1/2 sm:h-[658px] lg:h-[984px] relative lg:w-5/12 ">
            <img src={strategic} alt="" className="w-full h-full z-0 sm:hidden"/>
            <img src={wave} alt=""
                 className="w-[63px] h-[29px] absolute -bottom-[15px] left-[24px] object-cover z-10 sm:bottom-auto sm:left-auto sm:top-[145px] sm:-right-[31px] lg:top-[234px]"/>
        ...
        <div
            className="w-full flex flex-col justify-start items-start py-[72px] px-6 sm:gap-y-8  sm:px-[69px] sm:py-[120px] lg:py-[200px] lg:px-[154px] sm:w-1/2 lg:w-7/12 ">
            <h3 className="  font-com font-extrabold not-italic text-[32px] leading-[40px] lg:text-[56px] lg:leading-[64px] ">
